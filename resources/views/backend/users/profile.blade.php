...
@section('title', $user->fullName.' Profilini Düzenle')
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account"
                               aria-controls="account" role="tab" aria-selected="true">
                                <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">Hesap</span>
                            </a>
                        </li>
{{--                        <li class="nav-item">--}}
...
{{--                                <i class="feather icon-info mr-25"></i><span class="d-none d-sm-block">Bilgiler</span>--}}
{{--                            </a>--}}
{{--                        </li>--}}
{{--                        <li class="nav-item">--}}
...
{{--                                <i class="feather icon-share-2 mr-25"></i><span class="d-none d-sm-block">Sosyal Medya</span>--}}
{{--                            </a>--}}
{{--                        </li>--}}
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                            ...
                            <div class="media mb-2">
                                ...
                                <div class="media-body mt-50">
                                    ...
                                    <div class="col-12 d-flex mt-1 px-0">
                                        ...
                                        <a href="#" class="btn btn-outline-danger d-none d-sm-block">Kaldır</a>
                            ...
                            <form novalidate method="POST" action="{{ route('user.update',$user) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                <label>Soyad</label>
                                                <input type="text" class="form-control" name="surname" placeholder="Name" value="{{$user->surname}}" required
                                    ...
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="isActive">
                                                ...
                                                <option value="2">Bloklanmıi</option>
                                        ...
                                        <div class="form-group">
                                            <label>Şirket</label>
                                            <input type="text" class="form-control" value="Yanak Alüminyum"
                                    ...
                                    <div class="col-12">
                                        <div class="table-responsive border rounded px-1 ">
                                            <h6 class="border-bottom py-1 mx-1 mb-0 font-medium-2"><i
                                                        class="feather icon-lock mr-50 "></i>Yetkiler</h6>
                                    ...
                                    <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                                        ...
                                        <button type="reset" class="btn btn-outline-warning">Sıfırla</button>
                                    </div>
                                </div>
                            </form>
...
{{--                                <div class="row mt-1">--}}
{{--                                    <div class="col-12 col-sm-6">--}}
{{--                                        <h5 class="mb-1"><i class="feather icon-user mr-25"></i>Kişisel Bilgiler</h5>--}}
{{--                                        <div class="row">--}}
{{--                                            <div class="col-12">--}}
{{--                                                <div class="form-group">--}}
{{--                                                    <div class="controls">--}}
