...
$(document).ready(function(){
   ...
   // Twitter Feed
    ...
    // Contact form code
//form.form-newsletter, form.project-planner
    $('form.form-email,form.news-letter').submit(function(e) {
           ...
           // console.log('Send email form detected.');
            ...
            if (error === 1) {
                ...
                jQuery.ajax({
                    ...
                    type: "POST",
                    url: "/iletisim",
                    data: thisForm.serialize(),//thisForm.serialize()+"&url="+window.location.href,
                    success: function(response) {
